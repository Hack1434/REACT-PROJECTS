...
const App = () => {
  ...
  useEffect(() =>{
    axios.get("https://api.spotify.com/v1/search?q=Ride%20Twenty%20One%20Pilots&type=track&limit=1").then(
      res => {
  ...
  return (
    <div>
        ...
        <div className="container-fluid">
            <h3 className="navbar-brand">Chary Music Player <span style={{color:"blue"}}>𝄞</span>	</h3>
